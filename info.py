...
PICS = (environ.get('PICS', 'https://iili.io/KGNg20g.md.jpg https://iili.io/KGNP9yJ.md.jpg https://iili.io/KGNi8Je.md.jpg https://iili.io/KGNQ7xj.md.jpg https://iili.io/KGNQUen.md.jpg')).split()
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://i.ibb.co/2769f1rF/photo-2025-09-03-14-48-34-7548400762112442372.jpg")
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6497757690 6398757880').split()]
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003134967010'))
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001868871195'))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
AUTH_CHANNELS = [int(ch) for ch in environ.get("AUTH_CHANNELS", "-1001572271892").split() if ch and id_pattern.match(ch)]
AUTH_REQ_CHANNELS = [int(ch) for ch in environ.get("AUTH_REQ_CHANNELS", "-1003466956505").split() if ch and id_pattern.match(ch)]
...
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', '-1004294321324'))
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/How_to_Download_7x/30")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_to_Download_7x/30")
SHORTENER_API = environ.get("SHORTENER_API", "8a29727e87bad769eb615995cc8509c16c6a2f07")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "https://arolinks.com")
SHORTENER_API2 = environ.get("SHORTENER_API2", "8a29727e87bad769eb615995cc8509c16c6a2f07")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "https://arolinks.com")
SHORTENER_API3 = environ.get("SHORTENER_API3", "8a29727e87bad769eb615995cc8509c16c6a2f07")
